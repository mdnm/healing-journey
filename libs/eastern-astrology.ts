...
export const signToCharacteristicsMap: Record<
  Animal,
  {
...
> = {
  ...
  Gato: {
    ...
    negativeQualities: [
      ...
      "Pessimista",
      "Hesitante",
      "Tende a desperdiçar dinheiro",
      "Medo (Daí o termo 'Scaredy-cat' ou Gato medroso)",
    ],
  },
  Dragão: {
    positiveQualities: [
...
export const easternElementInfoMap: Record<
  EarthElement,
  {
    positiveQualities: string[];
    negativeQualities: string[];
...
> = {
  Fogo: {
    positiveQualities: [
      ...
      "sedutor",
      "afetuoso",
      "dá tudo em relacionamentos",
      "inspira outros com ações determinadas",
      "atrai pessoas como um ímã",
    ],
    negativeQualities: [
  ...
  Terra: {
    positiveQualities: [
      ...
      "confiável",
      "coordenado",
      "leva as responsabilidades a sério",
      "sacrifica-se pelos outros",
      "pensador claro",
      "as pessoas vêm até você em busca de conselhos",
      "confia na lógica em vez das emoções",
    ],
    negativeQualities: [
      "Controlador",
      "quer controlar o próprio destino",
      "não confia na própria intuição",
      "super analisa os parceiros românticos, mas uma vez que a confiança é conquistada, eles podem confiar em você para sempre",
    ],
  },
  Metal: {
    positiveQualities: [
      ...
      "sofisticado",
      "independente",
      "cuida dos entes queridos",
      "gosta de luxo",
      "conforto e liberdade",
      "cria seu próprio sucesso",
    ],
    negativeQualities: [
      "Teimoso",
      "exigente",
      "retalia rapidamente",
      "precisa que seu parceiro romântico siga sua liderança",
      "não pede ajuda aos outros",
    ],
  },
  Água: {
    positiveQualities: [
      ...
      "calmo",
      "passivo",
      "ganha confiança/afeto dos outros facilmente",
      "as pessoas seguem sua liderança",
      "faz todos se sentirem especiais",
      "influencia os pensamentos das pessoas",
    ],
    negativeQualities: [
      "Manipulador",
      "Indeciso",
      "sempre tenta ser agradável e fazer todos felizes, o que leva à depressão",
    ],
  },
  Madeira: {
    positiveQualities: [
      ...
      "excelente amigo ou colega",
      "sempre crescendo e progredindo",
      "orientado para casamento e família",
    ],
    negativeQualities: [
      "Se apega rapidamente ao parceiro",
      "trabalha demais",
      "passivo",
      "facilmente influenciado",
    ],

...
export const lifePathInfoMap: Record<LifePath, string> = {
  ...
  [6]: "Quando em harmonia: Família, Lar, Amizade, Fertilidade, Caseiro, Ermitão, Nutridor, Amoroso, Responsável, Moral, Orientado para a família, Inteligência ok na média (10% são gênios). Quando em desarmonia: Preguiçoso, Teimoso, Precisa de apreciação, Gula.",

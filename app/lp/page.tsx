      ...
      <main className="flex flex-col items-center gap-5 py-8">
        ...
        <section className="bg-base-200 w-full">
          <div className="max-w-screen-lg  mx-auto p-8 flex flex-col items-center gap-3">
            ...
            <p className="text-lg">
              A numerologia é uma ciência oculta que estuda a influência dos
              números em nossa vida. Estamos num mundo onde tudo é
              energia/frequência e pode ser reduzido a um número.
            </p>
            <p className="text-lg">
              A numerologia pode ser aplicada em qualquer coisa (pessoas,
              animais, lugares, objetos). Porém a energia não é definitiva, tudo
              gira em torno de probabilidades e o universo possui outras leis
              que nos afetam. A ideia é utilizar das probabilidades ao nosso
              favor e cumprir nossa missão nessa vida.
            </p>

            <p className="text-lg">
              A astrologia ocidental usa o calendario solar e é baseada no
              zodíaco tropical, que considera a posição do sol e outros astros
              em relação a terra. Já a astrologia oriental (chinesa ou
              vietnamita por exemplo) usa o calendario lunissolar (lua e sol) e
              é baseada em animais e elementos do nosso planeta, por isso ela é{" "}
            ...
            <p className="text-lg">
              ...
              habilidades, tendências, oportunidades, energias opostas, etc.
              Além de dizer quais horas, meses e anos serão{" "}
              <span className="font-bold">favoráveis ou desfavoráveis</span>{" "}
              para você.
            </p>
            ...
            <p className="text-xl">
              Além do autoconhecimento, você pode usar isso para decidir as
              melhores datas para:
            </p>
